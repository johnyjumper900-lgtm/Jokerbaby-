...
export const HoloCard = forwardRef<HTMLDivElement, HoloCardProps>(function HoloCard(
  ...
  return (
    <div
      ref={ref}
      className={cn("relative rounded-2xl overflow-hidden p-[1.5px] group", className)}
    >
      <motion.div
        animate={{ rotate: 360 }}
        ...
        style={{
          backgroundImage: `conic-gradient(from 180deg at 50% 50%, transparent 0deg, var(--primary) 90deg, var(--secondary) 180deg, var(--accent) 270deg, transparent 360deg)`,
        }}
      />
      <div
        className={cn(
