...
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='wina_sports' AND policyname='Public read wina_sports') THEN
...
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='wina_tournaments' AND policyname='Public read wina_tournaments') THEN
...
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='magic_analyses' AND policyname='Public read magic_analyses') THEN
